...
class UserMenuChildController extends Controller
{
    ...
    public function create($id)
    {
        ...
        return view('private.developer.management.user-menu-child.create', $data);
    }
    ...
    public function show($id)
    {
        ...
        return view('private.developer.management.user-menu-child.show', $data);
    }
    ...
    {
        $data['menuChild']              = UserMenuChild::where('uuid', $id)->first();
        return view('private.developer.management.user-menu-child.update', $data);
    }
