...
class UserMenuParentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('private.level.developer.management.menu.parent.index', $data);
    }
    ...
    {
        return view('private.level.developer.management.menu.parent.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('private.level.developer.management.menu.parent.show', $data);
    }
    ...
    {
        $data['menuParent']             = UserMenuParent::where('uuid', $id)->first();
        return view('private.level.developer.management.menu.parent.update', $data);
    }
