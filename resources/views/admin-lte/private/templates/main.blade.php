@include('admin-lte.private.templates.header')
@include('admin-lte.private.templates.nav')
@include('admin-lte.private.templates.sidebar')
...
@include('admin-lte.private.templates.footer')
