        ...
        <div class="col-md-9 col-lg">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-row">
                        <x-form-input-row-readonly type="text" name="created_at" label="dibuat" :value="$level->created_at->diffForHumans() .
                            ', ' .
                            $level->created_at->format('d-m-Y, H:i:s')"
                            class="col" />
                        <x-form-input-row-readonly type="text" name="updated_at" label="diubah" :value="$level->updated_at->diffForHumans() .
                            ', ' .
                            $level->updated_at->format('d-m-Y, H:i:s')"
                            class="col" />
                    </div>
                </div>
            </div>
