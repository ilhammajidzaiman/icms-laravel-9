        ...
        <div class="col-md-9 col-lg">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-row">
                        <x-form-input-row-readonly type="text" name="url" label="url" :value="$menu->url"
                            class="col" />
                    </div>

                    <div class="form-row">
                        <x-form-input-row-readonly type="text" name="created_at" label="dibuat" :value="$menu->created_at->diffForHumans() .
                            ', ' .
                            $menu->created_at->format('d-m-Y, H:i:s')"
                            class="col" />
                        <x-form-input-row-readonly type="text" name="updated_at" label="diubah" :value="$menu->updated_at->diffForHumans() .
                            ', ' .
